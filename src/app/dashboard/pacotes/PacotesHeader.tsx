      ...
      >
        <form action={async (formData) => {
          ...
          <div className="flex flex-col gap-1">
            ...
            <select name="roast_batch_id" required className="text-sm">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input name="retail_price" type="number" step="0.01" min="0" placeholder="Ex: 45.90" required className="text-sm border-[--primary]/30 focus:border-[--primary]" />
