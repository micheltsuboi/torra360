        ...
        <div className="glass-panel overflow-hidden">
           ...
           <div className="responsive-table-container">
            <table className="w-full text-left border-collapse min-w-[900px]">
              <thead>
                <tr className="text-[--secondary-text] text-[10px] uppercase tracking-widest border-b border-[--card-border] bg-white/5">
                  ...
                  <th className="p-4 font-bold text-right border-l border-white/5 uppercase">Ações</th>
                </tr>
              </thead>
                      ...
                      <tr key={lot.id} className="border-b border-[--card-border]/50 hover:bg-white/5 transition-colors group">
                        <td className="p-4">
                           <div className="flex flex-col">
                             ...
                             <span className="text-[10px] text-[--secondary-text] uppercase font-bold tracking-widest">{lot.origin || 'Origem N/A'} • {lot.provider || 'Fornecedor N/A'}</span>
                           </div>
                        </td>
                        <td className="p-4 text-center border-l border-white/5">
                           <div className="flex flex-col items-center">
                             ...
                             <span className="text-[10px] text-[--secondary-text] uppercase">{lot.quality_level || '-'}</span>
                           </div>
                        </td>
                        <td className="p-4 text-right border-l border-white/5">
                           <div className="flex flex-col items-end">
                              <span className="data-value">{lot.total_qty_kg}</span>
                              <span className="text-[9px] text-[--secondary-text] uppercase font-bold opacity-30">kg comprados</span>
                           </div>
                        </td>
                        <td className="p-4 text-right">
                           <div className="flex flex-col items-end">
                              <span className="data-value text-[--primary]/80">{lot.total_roasted_qty.toFixed(2)}</span>
                              <span className="text-[9px] text-[--secondary-text] uppercase font-bold opacity-30">kg torrados</span>
                           </div>
                        </td>
                        <td className="p-4 text-center border-l border-white/5">
                           <div className="flex flex-col items-center">
                             <span className="font-bold text-sm text-[--foreground]">R$ {lot.total_cost.toFixed(2)}</span>
                             <span className="text-[9px] uppercase opacity-30 font-bold">R$ {costPerKgGreen.toFixed(2)}/kg</span>
                           </div>
                        </td>
                        <td className="p-4 text-right border-l border-white/10 bg-[--primary]/5">
                           <div className={`flex flex-col items-end ${lot.available_qty_kg < 10 ? 'text-[--danger]' : 'text-[--success]'}`}>
                              ...
                              <span className="text-[9px] uppercase font-bold tracking-widest">kg em estoque</span>
                           </div>
                        </td>
                        <td className="p-4 text-right border-l border-white/5">
                           <div className="flex flex-col items-end">
                             <span className="font-bold text-[--primary] text-base">R$ {estRoastedCost.toFixed(2)}</span>
                             <span className="text-[9px] uppercase opacity-40 font-bold">Custo Est. / kg</span>
                           </div>
                        </td>
                        <td className="p-4 text-right border-l border-white/5">
