-- Adicionar coluna para parâmetros de torra (lista dinâmica com editor de texto)
ALTER TABLE public.roast_batches 
ADD COLUMN IF NOT EXISTS roast_parameters jsonb DEFAULT '[]'::jsonb;

-- Atualizar view para incluir os parâmetros (opcional, mas bom para o histórico)
